...
const Contact = () => {
  return (
    <section id="contact" className="py-20 px-6 relative overflow-x-hidden">
      <div className="absolute right-0 top-0 w-72 h-72 bg-brand-blue/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            I'm currently available for new opportunities. Whether you have a question, a project in mind, or just want to say hi, I'll try my best to get back to you!
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
          ...
          >
            <div className="w-full h-full drop-shadow-[0_15px_35px_rgba(0,255,102,0.35)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 flex-1 w-full">
            ...
            >
              ...
              <span className="text-gray-300 font-medium">09912511138</span>
            </motion.a>
            ...
            >
              ...
              <span className="text-gray-300 font-medium text-sm">bagheri.mb81@gmail.com</span>
            </motion.a>
            ...
            >
              ...
              <span className="text-gray-300 font-medium">LinkedIn Profile</span>
            </motion.a>
            ...
            >
              ...
              <span className="text-gray-300 font-medium">GitHub Profile</span>
            </motion.a>
          </div>
