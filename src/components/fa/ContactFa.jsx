        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -top-4 left-0 sm:-left-8 glass-panel px-4 sm:px-5 py-2.5 sm:py-3 rounded-2xl rounded-br-none text-xs sm:text-sm font-medium text-white shadow-[0_10px_25px_rgba(0,255,102,0.2)] whitespace-nowrap border-brand-green/20 pointer-events-auto"
            >
              در ارتباط باشیم 🤙
            </motion.div>
          </motion.div>
